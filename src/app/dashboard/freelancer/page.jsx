  ...
  return (
    <div className="flex flex-col gap-8 pb-10">
      ...
      >
        ...
        <Link href="/browse-tasks" className="bg-gray-900 text-white font-bold px-6 h-11 rounded-xl shadow-md hover:bg-black transition-all flex items-center gap-2 w-fit">
      ...
      >
        <div className="w-full bg-white border border-gray-200 rounded-2xl p-8 md:p-12 text-center flex flex-col items-center justify-center shadow-sm">
          ...
          <Link href="/browse-tasks" className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-6 rounded-xl shadow-sm transition-colors">
            Browse Open Tasks
          </Link>
        </div>
      </motion.div>
